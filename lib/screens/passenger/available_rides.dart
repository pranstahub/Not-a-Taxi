...
import '../../services/route_checker.dart';
        ...
        child: Column(
          ...
          children: [const SizedBox(height: 300.0),
            ...
            style:TextStyle(fontSize: 18)),
                ...
                else if (!snapshot.data!.isNotEmpty) { print("hello");
                  return Column(
                    children: [
                            for (int i = 0; i < snapshot.data![0].toInt(); i++)
                              FutureBuilder<List>(
                                  ...
                                  builder: (context, ridesnapshot) {
                                    k = i;
                                    Future<bool> matched = checkPassengerPathInDriverPath(
                      ...
                      return ListView.builder(
                        ...
                        onTap: () async{
                          await Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => ConfirmRideScreen(idCar: ridesnapshot.data![0][4].toString()),
                            ),
                          );
