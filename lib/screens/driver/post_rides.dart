...
import 'package:not_a_taxi/screens/driver/driver_metamask.dart';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        if (_controller.text.isEmpty || _destinationController.text.isEmpty
                            || _dateController.text.isEmpty || timeinput == null ||
                            passengerLimitController.text.isEmpty ) {
                              CustomSnackBar(context, const Text('Values Missing!'));
                            }
                          else {
                          ...
                          createRide(departureLocation, destination, departureDate, 
                              ...
                              CustomSnackBar(context, const Text('Ride Posted!'));
                         Timer(Duration(seconds: 3), () { // <-- Delay here
              setState(() {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => metaMaskDriver(),
                            ),
                          ); }); } ); }
                        },
