...
class DatabaseManager {
  ...
  Future<void> createUserData(String firstName, String secondName, String imgURL, String uid) async {
    return await profileList
      .doc(uid)
        .set({'First Name': firstName, 'Second Name': secondName, 'PFP URL': imgURL});
  }
