...
Future<String> createRide(String origin, String destination, String departureTime, Web3Client ethClient)
        async {
          var response = 
          await callFunction('createRide', [origin, destination, departureTime], ethClient, owner_private_key);
        print("Ride Created Succesfully!");
        print(response);
        return response;
        }
